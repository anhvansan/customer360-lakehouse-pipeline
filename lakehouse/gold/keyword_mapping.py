...
Chuẩn hóa text (bỏ dấu), nạp luật từ reference/keyword_category_mapping.csv,
ưu tiên khớp cụm dài trước, dùng ranh giới từ cho từ khóa ngắn để tránh khớp nhầm.
"""
...
def make_categorize_udf(rules: List[Dict[str, Any]]):
    """Tạo UDF phân loại, đóng gói sẵn `rules` theo closure (broadcast tự động qua serialize)."""
